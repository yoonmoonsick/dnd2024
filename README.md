...
**Caution**
- Might be a crash when respec or LvL up your character after installing or updating a mod.
...
- LvL 3: Psionic Power: You harbor a wellspring of psionic energy within yourself. It is represented by your Psionic Energy Dice, which fuel powers you have from this subclass. The Psi Warrior Energy Dice table shows the die size and number of these dice you have when you reach certain Fighter LvL. You regain one of your expended Psionic Energy Dice when you finish a Short Rest, and you regain all of them when you finish a Long Rest.
    ...
    - Psi Warror Energy Dice
        - Fighter LvL: 3, Size: D6, Number: 4
        - Fighter LvL: 5, Size: D8, Number: 6
        - Fighter LvL: 9, Size: D8, Number: 8
        - Fighter LvL: 11, Size: D10, Number: 8
- LvL 7: Telekinetic Adept: You have mastered new ways to use your telekinetic abilities, detailed below.
...
- LvL 3: Purple Dragon Companion: You are bonded with an amethyst dragon hatchling that serves as your purple dragon companion and uses the Purple Dragon Companion stat block. The purple dragon is Friendly to you and your allies and obeys your commands.
...
- LvL 3: Implements of Mercy: You gain proficiency in the Insight and Medicine skills and proficiency with the Herbalism Kit.
...
- LvL 3: Inspiring Smite: Immediately after you cast Divine Smite, you can expend one use of your Channel Divinity and distribute Hit Points to creatures of your choice within 30 feet of yourself, which can include you. The total number of Hit Points equals 2d8 plus your Paladin LvL, divided among the chosen creatures however you like.
...
- Clockwork  Spells (Always prepared) 
    ...
    - LvL 3: Aid, Lesser Restoration
    - LvL 5: Counter Spell, Protection from Energy
    - LvL 7: Freedom of Movement, Summon Construct
    - LvL 9: Greater Restoration, Wall of Force
- LvL 3: Restore Balance: Your connection to the plane of absolute order allows you to equalize chaotic moments. When a creature you can see within 60 feet of yourself is about to roll a d20 with Advantage or Disadvantage, you can take a Reaction to prevent the roll from being affected by Advantage and Disadvantage. You can use this feature a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
...
- Wildmagic Spells (Always prepared) 
    ...
    - LvL 3: EnlargeReduce, MistyStep	
    - LvL 5: Blink, Counterspell	
    - LvL 7: Polymorph, DimensionDoor	
    - LvL 9: Telekinesis, WallWallOfStone	
